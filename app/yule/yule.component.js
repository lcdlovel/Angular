...
var yuleComponent = (function () {
    function yuleComponent() {
        this.option = [
    ...
    yuleComponent.prototype.ngOnInit = function () { };
    yuleComponent = __decorate([
        core_1.Component({
            selector: 'yule',
            templateUrl: './yule.component.html',
            styleUrls: ['app/assets/css/content.css']
        }), 
        __metadata('design:paramtypes', [])
    ], yuleComponent);
    return yuleComponent;
}());
exports.yuleComponent = yuleComponent;
//# sourceMappingURL=yule.component.js.map