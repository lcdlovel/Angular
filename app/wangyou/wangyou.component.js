...
var wangComponent = (function () {
    function wangComponent() {
        this.option = [
    ...
    wangComponent.prototype.ngOnInit = function () { };
    wangComponent = __decorate([
        core_1.Component({
            selector: 'wang',
            templateUrl: './wangyou.component.html',
            styleUrls: ['app/assets/css/content.css']
        }), 
        __metadata('design:paramtypes', [])
    ], wangComponent);
    return wangComponent;
}());
exports.wangComponent = wangComponent;
//# sourceMappingURL=wangyou.component.js.map