...
var siglComponent = (function () {
    function siglComponent() {
        this.option = [
    ...
    siglComponent.prototype.ngOnInit = function () { };
    siglComponent = __decorate([
        core_1.Component({
            selector: 'sigl',
            templateUrl: './sigl.component.html',
            styleUrls: ['app/assets/css/content.css']
        }), 
        __metadata('design:paramtypes', [])
    ], siglComponent);
    return siglComponent;
}());
exports.siglComponent = siglComponent;
//# sourceMappingURL=sigl.component.js.map