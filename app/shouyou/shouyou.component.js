...
var shouComponent = (function () {
    function shouComponent() {
        this.option = [
    ...
    shouComponent.prototype.ngOnInit = function () { };
    shouComponent = __decorate([
        core_1.Component({
            selector: 'shou',
    ...
    return shouComponent;
}());
exports.shouComponent = shouComponent;
//# sourceMappingURL=shouyou.component.js.map